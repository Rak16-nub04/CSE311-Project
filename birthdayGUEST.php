...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_guest_info'])) {
    $birthday_event_id = $_POST['birthday_event_id'];
    $guest_name = $_POST['guest_name'];
    $num_members = $_POST['num_members'];
    $gift = $_POST['gift'];

    $insert_sql = "INSERT INTO birthday_guests (birthday_event_id, guest_name, num_members, gift) VALUES ('$birthday_event_id', '$guest_name', '$num_members', '$gift')";
...
<head>
    ...
    <title>Birthday Event Guest Information</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css">
</head>
<body>

<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="birthdayCHECK.php">Go Back to Birthday Events Dashboard</a>
...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        <div class="col-md-6 offset-md-3">
            <form method="post" action="birthdayGUEST.php">
                <input type="hidden" name="birthday_event_id" value="<?php echo $_POST['birthday_event_id']; ?>">
